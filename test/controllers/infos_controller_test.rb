...
class InfosControllerTest < ActionController::TestCase
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post :create, info: { description: @info.description, email: @info.email, first_name: @info.first_name, last_name: @info.last_name }
    end
  ...
  test "should update info" do
    patch :update, id: @info, info: { description: @info.description, email: @info.email, first_name: @info.first_name, last_name: @info.last_name }
    assert_redirected_to info_path(assigns(:info))
  end
